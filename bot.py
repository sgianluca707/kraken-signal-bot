...
- Analisi: trend 1h, struttura 15m e breakout 5m.
...
def quality_score(
    ...
    score += min(1.5, max(0.0, close_strength * 1.5))
...
def analyse_asset(
    ...
    quality = quality_score(
        trend_strength, extension_pct, close_strength, rr2_net
    )
...
def format_setup(s: Setup, age_seconds: int) -> str:
    ...
    aggressive = (
        ...
        "momentum della candela e trend 1h rialzista\n"
...
def run_once(cfg: Dict[str, Any], pairs: Dict[str, Dict[str, str]]) -> None:
    ...
    header = (
        ...
        "Analisi: trend 1h, struttura 15m e ingresso 5m.\n"
